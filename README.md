...
- The kernel is able to execute Lean 4 commands/tatics, and echoes the input using alectryon style annotation with output messages, see [tutorial.ipynb](https://nbviewer.org/github/utensil/lean4_jupyter/blob/main/examples/tutorial.ipynb?flush_cache=true).
